  ...
  >
    ...
    <g fill="none" fillRule="evenodd">
      ...
      <g transform="translate(0 11.083)">
        <mask id="raindrop_svg__b" fill="#fff">
          <use xlinkHref="#raindrop_svg__a" />
        </mask>
        <use xlinkHref="#raindrop_svg__a" fill="#2CD4ED" />
        <path
          fill="#0DB4E2"
          ...
          mask="url(#raindrop_svg__b)"
        />
      </g>
      <g transform="translate(19 11.083)">
        <mask id="raindrop_svg__d" fill="#fff">
          <use xlinkHref="#raindrop_svg__c" />
        </mask>
        <use xlinkHref="#raindrop_svg__c" fill="#3169FF" />
        <path
          fill="#3153FF"
