...
const SvgKickDark = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g clipPath="url(#kick-dark_svg__a)">
      <g clipPath="url(#kick-dark_svg__b)">
        <path
          fill="#FFF"
          fillRule="evenodd"
    ...
    <defs>
      <clipPath id="kick-dark_svg__a">
        <path fill="#fff" d="M0 0h933v300H0z" />
      </clipPath>
      <clipPath id="kick-dark_svg__b">
        <path fill="#fff" d="M0 0h933.333v300H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgKickDark;
