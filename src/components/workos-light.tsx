...
const SvgWorkosLight = (props: SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    xmlSpace="preserve"
    id="workos-light_svg__Layer_1"
    width={250}
    height={250}
    x={0}
    y={0}
    ...
    {...props}
  >
    <style>{".workos-light_svg__st0{fill:#fff}"}</style>
    <path
      id="workos-light_svg__logo-icon"
      ...
      className="workos-light_svg__st0"
    />
    <path
      id="workos-light_svg__logo-icon_1_"
