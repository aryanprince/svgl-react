...
const SvgWorkos = (props: SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    xmlSpace="preserve"
    id="workos_svg__Layer_1"
    width={250}
    height={250}
    x={0}
    y={0}
    ...
    {...props}
  >
    <style>{".workos_svg__st0{fill:#6363f1}"}</style>
    <path
      id="workos_svg__logo-icon"
      ...
      className="workos_svg__st0"
    />
    <path
      id="workos_svg__logo-icon_1_"
