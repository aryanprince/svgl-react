...
const SvgTor = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <defs>
      <linearGradient id="tor_svg__a" x1="50%" x2="50%" y1="100%" y2="0%">
        <stop offset="0%" stopColor="#420C5D" />
        <stop offset="100%" stopColor="#951AD1" />
      </linearGradient>
      <linearGradient id="tor_svg__b" x1="50%" x2="50%" y1="100%" y2="0%">
        <stop offset="0%" stopColor="#420C5D" />
        <stop offset="100%" stopColor="#951AD1" />
      </linearGradient>
    </defs>
