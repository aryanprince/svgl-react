...
const SvgRelagitIconLight = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g mask="url(#relagit-icon-light_svg__a)">
      <path
        fill="#000"
        fillRule="evenodd"
      ...
      <g mask="url(#relagit-icon-light_svg__b)">
        <path
          fill="#000"
          fillRule="evenodd"
...
export default SvgRelagitIconLight;
